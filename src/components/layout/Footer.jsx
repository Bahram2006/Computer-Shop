    ...
    <footer className="w-full bg-[#1e2124] text-gray-400 font-sans mt-10">
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-2">
             <span className="text-2xl font-black text-white tracking-tighter italic">SUMBAR</span>
             <span className="text-xs bg-red-600 text-white px-1 font-bold">COMPUTER</span>
          </div>
          <div className="text-[13px] leading-relaxed flex flex-col gap-4">
            <p className="flex items-start gap-3">
              <span className="text-red-500">📍</span>
              <span>Türkmenistan, Aşgabat, köç. A.Nyýazow (Hudayberdiýew), jaý 99</span>
            </p>
            <p className="flex items-center gap-3">
              <span className="text-red-500">📧</span>
              <a href="mailto:sumbar.computer@gmail.com" className="hover:text-white">sumbar.computer@gmail.com</a>
            </p>
            <p className="flex items-center gap-3">
              <span className="text-red-500">📞</span>
        ...
        <div className="grid grid-cols-2 gap-4 text-[12px] pt-2">
           <ul className="flex flex-col gap-4">
              ...
              <li className="hover:text-white cursor-pointer transition">Galereýa</li>
              <li className="hover:text-white cursor-pointer transition">Gizlinlik syýasaty</li>
           </ul>
           <ul className="flex flex-col gap-4">
              ...
              <li className="hover:text-white cursor-pointer transition">Brendler</li>
              <li className="hover:text-white cursor-pointer transition">Bal toplamak</li>
           </ul>
        </div>
        ...
        <div className="flex flex-col gap-8">
           <div>
              <h4 className="text-white font-bold text-[12px] mb-4 uppercase tracking-widest">Täzeliklere abuna boluň</h4>
              <div className="flex h-11">
                 <input type="email" placeholder="E-poçtaňyz" className="bg-[#282c31] border border-gray-700 text-white px-4 flex-1 outline-none text-sm rounded-l-md focus:border-red-600 transition-all" />
                 <button className="bg-red-600 text-white px-5 text-xs font-black uppercase rounded-r-md hover:bg-red-700 transition cursor-pointer">OK</button>
              </div>
           </div>
           <div>
              <h4 className="text-white font-bold text-[12px] mb-3 uppercase tracking-widest">Websaýty gowulaşdyrmaga kömek ediň</h4>
        ...
        <div className="bg-[#282c31]/50 p-6 rounded-xl border border-gray-700/50 flex flex-col items-center shadow-lg">
           <h4 className="text-white font-bold text-[11px] mb-5 uppercase tracking-[0.2em]">Programmany ýükläň:</h4>
           <div className="flex items-center gap-5 w-full">
              <div className="bg-white p-2 rounded-lg shadow-white/5">
                 {/* Hakyky QR kod suratyňy şu taýda ulanyp bilersiň */}
                 <div className="w-20 h-20 bg-gray-200 flex items-center justify-center text-[8px] text-black font-bold">QR CODE</div>
              </div>
           ...
           <p className="text-[10px] text-gray-500 mt-5 text-center leading-tight">Mugt programmany ýükläp almak üçin skanirleň</p>
        </div>
      ...
      <div className="bg-[#111315] py-8 border-t border-gray-800/50">
         <div className="max-w-[1400px] mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] font-medium">
            <p>© 2026 <span className="text-white">sumbar-computer.com</span> Ähli hukuklary goraglydyr.</p>
